...
class ReportBugDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        file_mode_outer_layout = QHBoxLayout()
        file_mode_outer_layout.addSpacing(20)
        file_mode_inner_layout = QVBoxLayout()
        ...
        file_mode_inner_layout.addWidget(self._snippets_radio)
        file_mode_inner_layout.addWidget(self._full_files_radio)
        file_mode_outer_layout.addLayout(file_mode_inner_layout)
        file_mode_outer_layout.addStretch()
        layout.addLayout(file_mode_outer_layout)
