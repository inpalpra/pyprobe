...
- **3-Stage Maximization Cycle:** A dedicated 'M' key workflow that cycles from normal grid layout to a container-maximized view, and finally to a "Full Focus" mode that hides all non-graph sidebars and code viewers for maximum forensic clarity.
