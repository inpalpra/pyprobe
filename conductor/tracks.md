...
- [x] **Track: when dragging markers in waveform graph or fft mag/phase lens of waveform, markers stick to the trace smoothly. the same is not true for complex waveforms.**
