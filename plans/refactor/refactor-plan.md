...
|--------|--------|--------|
| `main_window.py` | 1062 lines | ~400 lines |
| `probe_panel.py` | 811 lines | ~400 lines (split) |
| `tracer.py` | 630 lines | ~400 lines |
| Duplicate code | `waveform_plot.py` + `waveform.py` | Delete duplicate |
