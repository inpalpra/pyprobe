...
class TestE2EFolderBrowsingFast(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.a1_returncode, cls.a1_output = run_pyprobe(
            positional_arg=cls.examples_dir,
            auto_quit_timeout=0.5,
            timeout=10,
        )
        
        # A2: Open folder with probes ignored.
        cls.a2_returncode, cls.a2_output = run_pyprobe(
            positional_arg=cls.examples_dir,
            probes=["4:x:1"],
            auto_quit_timeout=0.5,
            timeout=10,
        ...
        # A3/A4: Open standard file test
        script = os.path.join(cls.folder_test_dir, "loop_script.py")
        cls.a3_returncode, cls.a3_output = run_pyprobe(
    ...
    def test_open_folder_cli_then_file(self):
        ...
        rely on ``--auto-quit-timeout`` for a hard-quit after 3 s (reduced to 0.5s for speed).
        """
        self.assertEqual(
            self.a1_returncode, 0,
            f"Expected clean exit (0) when opening a folder, got {self.a1_returncode}.\n"
            f"Output:\n{self.a1_output}",
        )
    ...
    def test_open_folder_with_probe_ignored(self):
        ...
        """
        self.assertEqual(
            self.a2_returncode, 0,
            f"Expected clean exit (0) with folder + --probe, got {self.a2_returncode}.\n"
            f"Output:\n{self.a2_output}",
        )
        plot_data = parse_plot_data(self.a2_output)
        self.assertEqual(
            plot_data, {},
    ...
    def test_open_file_in_folder_run_probe(self):
        ...
        """
        self.assertEqual(
            self.a3_returncode, 0,
            f"PyProbe exited with code {self.a3_returncode}.\nOutput:\n{self.a3_output}",
        )
        plot_data = parse_plot_data(self.a3_output)
