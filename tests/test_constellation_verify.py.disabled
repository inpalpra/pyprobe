...
class TestConstellationDataVerification(unittest.TestCase):
    ...
    def test_constellation_values_match_source(self):
        ...
        """
        script = os.path.join(self.repo_root, 'regression', 'constellation_verify.py')
        
        # Probe received_symbols at line 60 (the assignment line)
        plot_data = run_pyprobe_constellation_test(script, "60:received_symbols:1")
        ...
        # Load expected values from the JSON file the script writes
