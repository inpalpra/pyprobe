...
This skill defines the **Megascript Pattern**: combining individual test payloads into a single execution run, capturing all necessary state at once, and having individual tests simply assert against the pre-computed data.
